...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // Show proactive tooltip after 30s
  ...
  return (
    <a
      ...
      aria-label="Chat WhatsApp Reytrans"
    ...
    >
      ...
      {!showPromo && <span className={styles.tooltip}>Chat WhatsApp</span>}

      {/* Proactive tooltip after 30s */}
      {showPromo && (
        <span className={`${styles.tooltip} ${styles.tooltipPromo}`}>
          <span className={styles.tooltipOnline}>
